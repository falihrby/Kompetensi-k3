                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out bg-green-600 border border-transparent rounded-md hover:text-gray-200 focus:outline-none">
                                        <div class="px-2 text-right">
                                            <div class="text-base">{{ Auth::user()->name }}</div>
                                            <div class="text-gray-100">{{ Auth::user()->email }}</div>
                                        </div>
                                        <div class="ms-1">
