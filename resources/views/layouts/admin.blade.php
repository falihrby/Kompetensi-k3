        ...
        <aside :class="{ '-translate-x-full': !open }"
            ...
            <div class="flex items-center justify-between px-2">
                <div class="flex items-center space-x-2">
                    <span class="text-xl font-extrabold">Admin</span>
                </div>
                <button type="button" @click="open = !open"
                    class="inline-flex items-center justify-center p-2 text-green-600 rounded-md md:hidden hover:bg-green-600 focus:outline-none hover:text-white">
            ...
            <!-- Nav links -->
            <div class="flex flex-col gap-1 px-4 py-8 mb-0 ml-0">
                ...
                <x-sidebar-nav-link :href="route('soal.soal-kompetensi')" :active="request()->routeIs('soal.soal-kompetensi')">
                    <x-slot name="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-6 h-6 mr-2">
                ...
                <!-- Submenu Departemen -->
                <div x-data="{ openDepartemen: false }">
                    <!-- Toggle Departemen -->
                    <button @click="openDepartemen = !openDepartemen"
                        class="flex items-center justify-start w-full gap-2 px-4 py-2 text-sm text-left text-gray-700 hover:text-green-600">
                        ...
                        {{ __('Departemen') }}
                        <svg :class="{ 'transform rotate-180': openDepartemen }" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="relative flex items-center justify-between h-16 md:justify-end">
                        <div class="absolute inset-y-0 left-0 flex items-center md:hidden">
                            <button type="button" @click="open = !open" @click.away="open = false"
                                class="inline-flex items-center justify-center p-2 text-white rounded-md hover:bg-white focus:outline-none hover:text-green-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="block size-6">
                        ...
                        <!-- Judul -->
                        <h2 class="pl-12 text-base font-medium text-white">
