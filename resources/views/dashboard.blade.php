            ...
            <div class="px-4 py-2 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-4 bg-gray-100 rounded-md overscroll-contain"
                        ...
                        <div class="text-sm text-gray-900">
                            <div class="space-y-4">
                                ...
                                <p>Welcome to www.lorem-ipsum.info. This site is provided as a service to our
                                    visitors
                                    and may be used for informational purposes only. Because the Terms and
                                    Conditions
                                ...
                                <p>PLEASE NOTE: We reserve the right, at our sole discretion, to change, modify or
                                    ...
                                    changes and/or modifications will constitute your acceptance of the revised
                                    Terms
                                ...
                                <p>This Site may contain links to other independent third-party Web sites ("Linked
                                    ...
                                    visitors.
                                    Such Linked Sites are not under our control, and we are not responsible for and
                                    does
                                    not endorse the content of such Linked Sites, including any information or
                                    materials
                                    contained on such Linked Sites. You will need to make your own independent
                                    judgment
                                    regarding your interaction with these Linked Sites.</p>
                                <p>4. FORWARD LOOKING STATEMENTS</p>
                                <p>All materials reproduced on this site speak as of the original date of
                                    publication or
                                    filing. The fact that a document is available on this site does not mean that
                                    the
                                    ...
                                    information or statements contained on this site and, therefore, such
                                    information or
                                    statements should not be relied upon as being current as of the date you access
                                    this
                                    site.</p>
                ...
                <div class="py-2">
                    <div class="p-4 m-4 text-left text-white bg-green-600 border-white rounded-lg"
                        style="opacity: 0.80;">
                        <p class="text-sm font-semibold">WAKTU DIMULAI KETIKA ANDA MENEKAN TOMBOL “MULAI KERJAKAN”
                        </p>
                    </div>
                </div>
