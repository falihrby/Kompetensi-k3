<!-- resources/views/hasil-kompetensi.blade.php -->
            ...
            <div class="px-4 py-2 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-4">
                    <div class="text-center">
                        @if ($result['isPassed'])
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-24 mx-auto text-green-500 w-18">
                        ...
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-24 h-24 mx-auto text-red-500">
