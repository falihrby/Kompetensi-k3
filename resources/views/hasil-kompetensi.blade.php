                ...
                <div class="p-4">
                    <div class="text-center">
                        @if ($result['isPassed'] === 'Tidak Lulus Ujian')
                            ...
                            <h2 class="mt-4 text-2xl font-semibold text-red-500">Tidak Lulus Kompetensi Umum</h2>
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            ...
                            <h2 class="mt-4 text-2xl font-semibold text-green-500">Lulus Kompetensi Umum</h2>
                        @endif
                    </div>
                ...
                @if ($result['isPassed'] === 'Tidak Lulus Ujian')
                    <div class="p-4 m-4 text-left text-white bg-green-600 border-white rounded-lg"
                        ...
                        <p class="text-sm font-base">Anda Tidak Dapat Melanjutkan Kompetensi Selanjutnya Karena
                            Tidak Lulus Kompetensi Ini. <span class="font-bold">Silahkan Ulangi Kompetensi Sampai
                                Lulus</span></p>
                    </div>
