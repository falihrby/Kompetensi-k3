// File: resources/views/pilih-lab.blade.php
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="p-4 mx-auto">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <div class="flex flex-col justify-start max-w-xs gap-4 p-6 mx-auto transition transform bg-white shadow-lg rounded-2xl hover:scale-105"
                        data-id="lab-fitisimat">
                        ...
                        <div class="flex w-full py-4">
                            <a href="{{ route('khusus-dashboard.index', ['labName' => 'Khusus FITISIMAT']) }}"
                    ...
                    <div class="flex flex-col justify-start max-w-xs gap-4 p-6 mx-auto transition transform bg-white shadow-lg rounded-2xl hover:scale-105"
                        ...
                        <div class="flex w-full py-4">
                            <a href="{{ route('khusus-dashboard.index', ['labName' => 'Khusus Kimia']) }}"
                                class="inline-flex px-4 py-2 font-bold text-white transition bg-green-600 rounded-md hover:bg-green-800">
                                <span>Masuk</span>
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col justify-start max-w-xs gap-4 p-6 mx-auto transition transform bg-white shadow-lg rounded-2xl hover:scale-105"
                        ...
                        <div class="flex w-full py-4">
                            <a href="{{ route('khusus-dashboard.index', ['labName' => 'Khusus Biologi']) }}"
                                class="inline-flex px-4 py-2 font-bold text-white transition bg-green-600 rounded-md hover:bg-green-800">
                                <span>Masuk</span>
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col justify-start max-w-xs gap-4 p-6 mx-auto transition transform bg-white shadow-lg rounded-2xl hover:scale-105"
                        ...
                        <div class="flex flex-col ">
                            ...
                            <hr class="w-full h-px my-2 bg-gray-400 border-0 dark:bg-gray-200">
                            <div class="text-sm font-normal text-zinc-600">
                                Lab ini untuk mendukung kegiatan penelitian dan pengabdian masyarakat dalam bentuk
                                layanan jasa pengujian.
                            </div>
                        </div>
                        <div class="flex w-full py-4">
                            <a href="{{ route('khusus-dashboard.index', ['labName' => 'Khusus Pengujian']) }}"
                                class="inline-flex px-4 py-2 font-bold text-white transition bg-green-600 rounded-md hover:bg-green-800">
                                <span>Masuk</span>
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col justify-start max-w-xs gap-4 p-6 mx-auto transition transform bg-white shadow-lg rounded-2xl hover:scale-105"
                        ...
                        <div class="flex w-full py-4">
                            <a href="{{ route('khusus-dashboard.index', ['labName' => 'Khusus Pertambangan']) }}"
                                class="inline-flex px-4 py-2 font-bold text-white transition bg-green-600 rounded-md hover:bg-green-800">
                                <span>Masuk</span>
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col justify-start max-w-xs gap-4 p-6 mx-auto transition transform bg-white shadow-lg rounded-2xl hover:scale-105"
                        data-id="lab-agribisnis">
                        <div class="flex flex-col ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="65" height="65"
                                viewBox="0 0 48 48" class="mb-4">
                            ...
                            <hr class="w-full h-px my-2 bg-gray-400 border-0 dark:bg-gray-200">
                            <div class="text-sm font-normal text-zinc-600">
                                Lab ini mencakup studi tentang manajemen dan produksi agribisnis
                            </div>
                        </div>
                        <div class="flex w-full py-4">
                            <a href="{{ route('khusus-dashboard.index', ['labName' => 'Khusus Agribisnis']) }}"
                                class="inline-flex px-4 py-2 font-bold text-white transition bg-green-600 rounded-md hover:bg-green-800">
                                <span>Masuk</span>
                            </a>
                        </div>
