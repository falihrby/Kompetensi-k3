        ...
        <div class="mb-12 sm:w-1/2">
            <div class="w-full p-4 bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="flex items-center my-4 space-x-4">
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->user_id }}</div>
                </div>
                <div class="flex items-center my-4 space-x-4">
                    <label class="flex justify-between w-1/3 text-sm font-medium text-gray-700">
                        <span>Nama</span>
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->nama }}</div>
                </div>
                <div class="flex items-center my-4 space-x-4">
                    <label class="flex justify-between w-1/3 text-sm font-medium text-gray-700">
                        <span>Nomor</span>
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->nomor }}</div>
                </div>
                <div class="flex items-center my-4 space-x-4">
                    <label class="flex justify-between w-1/3 text-sm font-medium text-gray-700">
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->program_studi }}</div>
                </div>
                <div class="flex items-center my-4 space-x-4">
                    <label class="flex justify-between w-1/3 text-sm font-medium text-gray-700">
                        <span>Fakultas</span>
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->fakultas }}</div>
                </div>
                <div class="flex items-center my-4 space-x-4">
                    <label class="flex justify-between w-1/3 text-sm font-medium text-gray-700">
                        <span>Instansi</span>
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->instansi }}</div>
                </div>
                <div class="flex items-center my-4 space-x-4">
                    <label class="flex justify-between w-1/3 text-sm font-medium text-gray-700">
                        <span>Email</span>
                ...
                <div class="flex items-center my-4 space-x-4">
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->password }}</div>
                </div>
                <div class="flex items-center my-4 space-x-4">
                    <label class="flex justify-between w-1/3 text-sm font-medium text-gray-700">
                    ...
                    <div class="w-2/3 p-2 text-sm border border-gray-300 rounded-lg bg-gray-50">{{ $akunPeserta->kategori_ujian_wajib }}</div>
                </div>
                <div class="flex items-center justify-between mt-4">
                    ...
                    <a href="{{ route('akun-peserta.edit', $akunPeserta->id) }}" class="inline-flex items-center justify-center px-4 py-2 space-x-2 text-white bg-green-600 rounded-md font-base hover:bg-green-800">
